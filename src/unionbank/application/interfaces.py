...
class NotificationServiceProtocol(Protocol):
    ...
    def notify_deposit(self, acc_no: str, amount: Decimal, balance: Decimal, txn_id: str) -> None: ...

    def notify_withdraw(self, acc_no: str, amount: Decimal, balance: Decimal, txn_id: str) -> None: ...
    ...
    def notify_interest(self, acc_no: str, amount: Decimal, balance: Decimal, txn_id: str) -> None: ...

    def notify_welcome(self, acc_no: str) -> None: ...

    def notify_loan_approved(self, acc_no: str, amount: Decimal, loan_type: str, loan_id: str) -> None: ...

    def notify_loan_rejected(self, acc_no: str, loan_type: str, loan_id: str, reason: str = "") -> None: ...

    def notify_emi_paid(
        self, acc_no: str, amount: Decimal, loan_type: str, loan_id: str, remaining: Decimal
    ) -> None: ...

    def notify_loan_closed(self, acc_no: str, loan_type: str, loan_id: str) -> None: ...

    def notify_account_frozen(self, acc_no: str, reason: str = "") -> None: ...

    def notify_account_unfrozen(self, acc_no: str) -> None: ...
