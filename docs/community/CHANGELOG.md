...
- **Forensic inventory** (`../reference/INVENTORY.md`) — Module-by-module classification as LIVE/DEAD/AMBIGUOUS with import-graph evidence. Zero AMBIGUOUS entries remaining.
...
- **../reference/RUNBOOK.md** — Incident response procedures, troubleshooting guides, operational runbook.
